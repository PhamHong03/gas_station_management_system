...
class GasStationFuelController extends Controller
{
    ...
    public function list($id)
    {
        ...
        return view('admin.gas-station-fuel.list', compact('gasStationFuels', 'gasStation'));
    }
    ...
    public function create($id)
    {
        ...
        return view('admin.gas-station-fuel.create', compact('gasStation', 'fuelTypes'));
    }
    ...
    public function store(AddGasStationFuelRequest $request)
    {
        ...
        return redirect()->route('admin.gas-station-fuel.list', ['id' => $request->GasStationId])->with('success', 'Thêm Nhiên liệu cho trạm xăng thành công');
    }
    ...
    public function edit($id, $id2)
    {
        ...
        return view('admin.gas-station-fuel.edit', compact('gasStationFuel', 'gasStation', 'fuelTypes'));
    }

    public function update(AddGasStationFuelRequest $request, $id, $id2)
    {
        $this->gasStationFuelAdService->update($id, $request);

        return redirect()->route('admin.gas-station-fuel.list', ['id' => $id2])->with('success', 'Cập nhật nhiên liệu thành công');
    }
