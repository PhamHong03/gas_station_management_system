...
@section('title', 'Thêm Công Ty quản lý')
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="page-header">
                <h3 class="page-title"> Thêm Công Ty quản lý</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.companies.list') }}">Công Ty quản lý</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Thêm Công Ty quản lý</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Thêm Công Ty quản lý</h4>
