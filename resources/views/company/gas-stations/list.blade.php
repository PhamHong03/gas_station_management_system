        ...
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('company.gas-stations.list') }}">Danh sách Cây xăng</a>
                        </li>
                    </ol>
                </nav>
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($gasStations as $gasStation)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('company.gas-stations.edit', ['id' => $gasStation->id]) }}"
                                                        class="btn btn-primary">Sửa</a>
                                                    <a href="{{ route('company.gas-station-fuel.list', ['id' => $gasStation->id]) }}"
                                                        class="btn btn-info">Xem nguyên liệu</a>
                                                    <a href="{{ route('company.gas-stations.delete', ['id' => $gasStation->id]) }}"
