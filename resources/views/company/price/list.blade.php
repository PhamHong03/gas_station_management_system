        ...
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('company.fuel-prices.list') }}">Danh sách Giá nhiên
                                liệu</a></li>
                    </ol>
                </nav>
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($prices as $price)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('company.fuel-prices.edit', ['id' => $price->id]) }}"
                                                        class="btn btn-primary">Sửa</a>
                                                    <a href="{{ route('company.fuel-prices.delete', ['id' => $price->id]) }}"
